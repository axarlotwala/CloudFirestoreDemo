...
public class MaterialFancyBtn extends LinearLayout {

    public static final String TAG = MaterialFancyBtn.class.getSimpleName();
    ...
    private String mLargeText = null;
    private int mDefaultLargeTextSize = FontUtil.spToPx(getContext(), 25);
     ...
     */
    public MaterialFancyBtn(Context context) {
        super(context);
     ...
     */
    public MaterialFancyBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initializeMaterialFancyButton() {
        ...
        mLargeTextView = setupLargeTextView();
        ...
        if (mIconPosition == POSITION_LEFT || mIconPosition == POSITION_TOP) {
            ...
            if (mLargeTextView != null) {
                views.add(mLargeTextView);
            }
    ...
    private TextView setupLargeTextView() {
        if (mText.equals("Self")) {
            String a1 = "";
        }
        if (mLargeText == null || mLargeText.equals("")) {
            return null;
            //mText = "Fancy Button";
        }
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        mDefaultLargeTextSize = (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_large_textSize, mDefaultTextSize);
        mLargeText = attrsArray.getString(R.styleable.MaterialFancyBtnAttrs_largeText);
        ...
        mDisabledBorderColor =
                attrsArray.getColor(R.styleable.MaterialFancyBtnAttrs_mfb_disabledBorderColor,
                        mDisabledBorderColor);
        mDefaultTextColor =
                attrsArray.getColor(R.styleable.MaterialFancyBtnAttrs_mfb_textColor, mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor =
                attrsArray.getColor(R.styleable.MaterialFancyBtnAttrs_mfb_iconColor, mDefaultTextColor);

        mDefaultTextSize =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_textSize,
                        mDefaultTextSize);
        mDefaultTextSize =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_android_textSize,
                        mDefaultTextSize);

        mDefaultTextGravity = attrsArray.getInt(R.styleable.MaterialFancyBtnAttrs_mfb_textGravity, mDefaultTextGravity);
        ...
        mFontIconSize =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_fontIconSize,
                        mFontIconSize);

        mIconPaddingLeft =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_iconPaddingLeft,
                        mIconPaddingLeft);
        mIconPaddingRight =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_iconPaddingRight,
                        mIconPaddingRight);
        mIconPaddingTop =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_iconPaddingTop,
                        mIconPaddingTop);
        mIconPaddingBottom =
                (int) attrsArray.getDimension(R.styleable.MaterialFancyBtnAttrs_mfb_iconPaddingBottom,
                        mIconPaddingBottom);

        mTextAllCaps =
                attrsArray.getBoolean(R.styleable.MaterialFancyBtnAttrs_mfb_textAllCaps, false);
        mTextAllCaps =
                attrsArray.getBoolean(R.styleable.MaterialFancyBtnAttrs_android_textAllCaps, false);
        ...
        mIconPosition = attrsArray.getInt(R.styleable.MaterialFancyBtnAttrs_mfb_iconPosition, mIconPosition);
        ...
        try {
            mIconResource = attrsArray.getDrawable(R.styleable.MaterialFancyBtnAttrs_mfb_iconResource);
        } catch (Exception e) {
            mIconResource = null;
        }

        mIcon = attrsArray.getString(R.styleable.MaterialFancyBtnAttrs_mfb_icon);
    ...
    public void setLargeText(String text) {
        if (text.length() > 3)
            mDefaultLargeTextSize = 32;

        text = mTextAllCaps ? text.toUpperCase() : text;
        this.mLargeText = text;
        if (mLargeTextView == null || text.length() > 3) {
            initializeMaterialFancyButton();
        } else {
            mLargeTextView.setText(text);
        }
    }
